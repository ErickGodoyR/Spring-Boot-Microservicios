...
public class UsuarioControlador {
	...
	//Comunicación de Microservicios (carros)
	//RestTemplate
	...
	//Comunicación de Microservicios (motos)
	//RestTemplate
	...
	(@PathVariable("usuarioId") int usuarioId,@RequestBody Carro carro){
	...
	(@PathVariable("usuarioId") int usuarioId,@RequestBody Moto moto){
